---
name: lagunite-colors
description: >-
  Lagunite text, background, and border color utilities. Use when setting
  foreground color, backgrounds, gradients, or border-color with classes from
  src/css/02-colors/ (01-text, 02-background, 03-border).
---
