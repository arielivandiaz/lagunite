---
name: lagunite-organisms
description: >-
  Lagunite page organisms: navbar, sidebar, footer. Use when building app
  chrome or marketing site shells from src/css/08-organisms/.
---
...
On small screens, `.navbar-nav` is hidden until **`.navbar.open`** (toggle class with JS on the same element as `.navbar`). Burger is visible only &lt;=639px.
