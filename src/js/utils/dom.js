// src/js/utils/dom.js
//
// Helpers DOM genericos reutilizados por demos y por consumidores del framework.
// (Este archivo contiene las funciones historicas que vivian en src/lagunite.js
//  antes del refactor que partio el JS por capas.)
